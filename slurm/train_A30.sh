#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# Chimera — UNet Benchmark Job (A30 partition)
#
# Submit:  sbatch slurm/train_A30.sh
...
# ─────────────────────────────────────────────────────────────────────────────
#SBATCH --job-name=unet_bench_A30
...
#   --out chimera_results_A30             → separate output dir

TRAIN_ARGS="--models all --epochs 50 --nnunet-epochs 50 --out chimera_results_A30"
